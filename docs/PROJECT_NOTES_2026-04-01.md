...
Se creó `docs/brain/` como sistema de memoria incremental más prolijo y profesional. Centraliza estado del proyecto, bugs, reglas del catálogo, reglas comerciales del bot, notas de deploy y casos de regresión para maximizar capacidad de IA incremental.
