...
export const env = (() => {
  const schema = z.object({
    ...
    BOT_WEBHOOK_SECRET: z.string().min(32, "BOT_WEBHOOK_SECRET must be at least 32 characters"),
    BOT_ADMIN_TOKEN: z.string().min(16, "BOT_ADMIN_TOKEN must be at least 16 characters"),
