          ...
          <div className="mt-6 pt-6 border-t border-gray-100">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
              <div>
                ...
                <p className="text-sm font-semibold">${quotation.basePrice.toLocaleString()}</p>
              </div>
              <div>
                <p className="text-xs text-gray-500 mb-1">Descuento</p>
                <p className="text-sm font-semibold text-green-600">-${quotation.discount.toLocaleString()}</p>
              </div>
              <div>
                <p className="text-xs text-gray-500 mb-1">Gastos Adic.</p>
                <p className="text-sm font-semibold">${quotation.additionalCosts.toLocaleString()}</p>
              </div>
              <div>
                <p className="text-xs text-gray-500 mb-1">Válida hasta</p>
                <p className="text-sm font-semibold">{format(new Date(quotation.validUntil), 'dd/MM/yyyy')}</p>
              </div>
            </div>
          </div>
        )}
