...
export default function TicketListItemTailwind({
  ...
  return (
    <div
      className={cn(
        "group relative overflow-hidden rounded-auto-lg border bg-auto-panel2 transition",
        isSelected
          ? "border-auto-accent/40 ring-2 ring-auto-accent/25"
          : "border-auto-border hover:border-auto-accent/20 hover:bg-auto-panel"
      )}
    >
      <span
      ...
      <button
        ...
        className={cn(
          "flex w-full gap-3 p-3 pr-3 text-left",
          isPending ? "cursor-default pr-28" : "cursor-pointer"
        )}
      >
